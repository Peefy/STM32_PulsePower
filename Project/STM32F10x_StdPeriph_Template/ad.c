...
void DMA_ADC1_Init(void)
{
	  ...
	  ADC_RegularChannelConfig(ADC1, ADC_Channel_5, 1, ADC_SampleTime_239Cycles5);   //A5
...
MovingAverageFilter_t ADFilter = {8};
void ADCdeal(void)  
{
  AD_Value[0] = MyMAFilter(&ADFilter,ADCConvertedValue[0]);
